...
flute = wind $ WindSpec 
    { windRange         = fromSpec fluteRangeSpec
    , windVibratoDur    = totalDur
    , windFreqDeviation = ((-0.03, 0), (0, 0.003), (-0.0015, 0), (0, 0.012)) 
    }
...
bassClarinet = wind $ WindSpec 
    { windRange         = fromSpec bassClarinetRangeSpec
    , windVibratoDur    = totalDur
    , windFreqDeviation = ((0, 0.015), (-0.005, 0), (0, 0.003), (0, 0.017)) 
    }
...
frenchHorn = wind $ WindSpec 
    { windRange         = fromSpec frenchHornRangeSpec
    , windVibratoDur    = totalDur
    , windFreqDeviation = ((-0.012, 0), (0, 0.005), (-0.005, 0), (0, 0.009)) 
    }
...
sheng = wind $ WindSpec 
    { windRange         = shengRange
    , windVibratoDur    = const 0.625
    , windFreqDeviation = ((-0.03, 0), (0, 0.003), (-0.0015, 0), (0, 0.012))
    }
...
hulusi = wind $ WindSpec 
    { windRange         = hulusiRange
    , windVibratoDur    = const 20
    , windFreqDeviation = ((-0.03, 0), (0, 0.003), (-0.0015, 0), (0, 0.012))
    }
